...
async fn main() -> Result<(), Error> {
    ...
    for chunk in &results {
            ...
            println!("num panels is {}",&chunk.results.len())        
    }
    for chunk in &results{
